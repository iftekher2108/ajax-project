...
while ($row = mysqli_fetch_array($execute)) { ?>
    ...
    <tr id="select<?php echo $row['id']; ?>">
        <td><input type="checkbox" value="<?php echo $row['id'] ?>" class="select_id"></td>
        ...
        <td class="bg-success user-select-none text-white-50" ><a onclick="item_delete( <?php echo $row['id']; ?> )" class="delete">delete</a></td>
